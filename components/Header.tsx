...
const BrainIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-indigo-500" viewBox="0 0 24 24" fill="currentColor" {...props}>
            ...
            <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex items-center space-x-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">
                        Deafness-Aware Lecture Transcription & Note Generator
                    </h1>
                    <p className="text-sm text-gray-500">
                        Your AI-powered assistant for accessible learning.
                    </p>
                </div>
            </div>
        </header>
